...
const std::map<SuperState, SuperStateInfo> state_info_ = {
  ...
  { SuperState::ARMING, { "ARMING", { SuperState::ARMED, SuperState::READY, SuperState::SHUTDOWN } } },
  { SuperState::ARMED, { "ARMED", { SuperState::AUTO, SuperState::DISARMING, SuperState::SHUTDOWN} } },
  { SuperState::AUTO,
    { "AUTO", { SuperState::DISARMING, SuperState::SEMI_AUTO, SuperState::HOLD, SuperState::ABORT, SuperState::MANUAL, SuperState::SHUTDOWN } } },
  { SuperState::DISARMING, {"DISARMING", { SuperState::READY, SuperState::SHUTDOWN } } },
  { SuperState::SEMI_AUTO,
    { "SEMI_AUTO", { SuperState::AUTO, SuperState::HOLD, SuperState::ABORT, SuperState::MANUAL, SuperState::SHUTDOWN} } },
  { SuperState::HOLD, { "HOLD", { SuperState::ABORT, SuperState::MANUAL,SuperState::SHUTDOWN } } },
  { SuperState::ABORT, { "ABORT", { SuperState::DISARMING, SuperState::MANUAL, SuperState::SHUTDOWN } } },
  { SuperState::MANUAL, { "MANUAL", { SuperState::DISARMING, SuperState::SHUTDOWN } } },
